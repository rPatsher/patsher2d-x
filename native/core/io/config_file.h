...
public:
    ...
    virtual void get_sections(List<String>& sections) const;
    virtual void erase_section(const String& section);
    void get_section_keys(const String& section,List<String>& keys) const;
    void save(const String& path);
    virtual void erase_section_key(const String& section, const String& key);
    virtual bool load(const String& path);
    virtual bool parse(const String& data);
